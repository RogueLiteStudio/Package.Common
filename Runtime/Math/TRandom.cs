...
namespace TrueSync
{
    ...
    public class TRandom
    {
         ...
         **/
        public static TRandom New(int seed)
        {
        ...
        private TRandom(int seed)
        {
            init_genrand((uint)seed);
        }

        private TRandom(int[] init)
        {
         ...
         **/
        public TFloat Next(float minValue, float maxValue)
        {
            ...
            return (TFloat.Floor((maxValueInt - minValueInt + 1) * NextFP() +
                minValueInt)) / 1000;
        }
         ...
         *  @brief Returns a {@link FP} between a min value [inclusive] and a max value [inclusive].
         **/
        public static TFloat Range(float minValue, float maxValue)
        {
            return instance.Next(minValue, maxValue);
        }
         ...
         **/
        public TFloat NextFP()
        {
            return ((TFloat)Next()) / (MaxRandomInt);
        }

        /**
         *  @brief Returns a {@link FP} between 0.0 [inclusive] and 1.0 [inclusive].
         **/
        public static TFloat value
        {
            get
            {
         ...
         **/
        public static TVector3 insideUnitSphere
        {
            get
            {
                return new TVector3(value, value, value);
            }
        }
        ...
        TFloat genrand_FP()
        {
            return (TFloat)genrand_int32() * (TFloat.One / (TFloat)4294967295);
        }
